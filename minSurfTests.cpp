...
#else
    string pathToImages("/Users/gestina/Desktop/minimalSurfaces_share"); // Mac
#endif
...
void sphereCoarsenTest(int choice){
    ...
    int imStart, imEnd;
    double voxdims[3]; string lengthUnit; string imageDir;
    if(choice == 0)
    {
        imageDir = pathToImages + "/T_test";  imStart=0, imEnd=2;  voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");//0-7
    }
     if(choice == 1)
     {
         imageDir = pathToImages + "/small_easy_test";  imStart=0, imEnd=0;  voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");
     }
    if(choice == 2)
    {
        string imageDir(pathToImages + "/small_network_test");  imStart=0, imEnd=7; voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");
    }
    if(choice == 3)
    {
        string imageDir(pathToImages + "/small_diag_test");  imStart=0, imEnd=7; voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");
    }
    if(choice == 4)
    {
        string imageDir(pathToImages + "/small_loop_test"); imStart=0, imEnd=7;voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");
    }
    if(choice == 5)
    {
        string imageDir(pathToImages + "/small_circle_test/small/smaller");  imStart=0, imEnd=9; voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");
    }
    
    if(choice == 6)
    {
        string imageDir(pathToImages + "/FITC-MCA0_N12_NIH001_s1_4"); imStart=0, imEnd = 66; voxdims[0] = 1.648; voxdims[1] = 1.648; voxdims[2] = 0.492;  thresh = 0.22; string lengthUnit("um");
    }
    
    if(choice == 7)
    {
        string imageDir(pathToImages + "/MacCL_168"); imStart=0, imEnd=167; voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("units");
    }
    
    if(choice == 8)
    {
        string imageDir(pathToImages + "/FITC-MCA0_N12_PI001_s1"); imStart=0, imEnd=61; voxdims[0] = 0.412; voxdims[1] = 0.412; voxdims[2] = 0.492; thresh = 0.07; string lengthUnit("um");
    }
    
    if(choice == 9)
    {
        string imageDir(pathToImages + "/Lung Images (Processed) - Study 2310 L2"); imStart=1, imEnd=337; voxdims[0] = 1.0; voxdims[1] = 1.0; voxdims[2] = 1.0; string lengthUnit("um"); // um units not to scale
    }
